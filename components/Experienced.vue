      ...
      <div class="block scroll-trigger-work-experience">
        <ol class="hidden sm:flex">
          <li class="relative mb-6 sm:mb-0 basis-1/3">
            ...
            <div class="mt-3 sm:pr-8">
              <h3 class="text-lg font-semibold text-white">Aktus Global Management</h3>
              <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
                April - July 2017
              </time>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                Improved and maintained the existing payroll system, i.e., Dashpayroll a desktop application.
              </p>
            </div>
          </li>
          <li class="relative mb-6 sm:mb-0 basis-1/3">
            ...
            <div class="mt-3 sm:pr-8">
              <h3 class="text-lg font-semibold text-white">EVRMC</h3>
              <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
                August 2017 - December 2020
              </time>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                Full-stack developer, tasked with developing and maintaining internal software, i.e., PDMS and WCPRS, to make the department's end-user tasks light, efficient, and effective.
              </p>
            </div>
          </li>
          <li class="relative mb-6 sm:mb-0 basis-1/3">
            ...
            <div class="mt-3 sm:pr-8">
              <h3 class="text-lg font-semibold text-white">Scibiz Informatics</h3>
              <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
                January 2021 - present
              </time>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                Develop stable software, mainly on the frontend. Implement UI/UX design and make sure the software project meets the required features.
              </p>
            </div>
          </li>
        </ol>
        ...
        <ol class="block md:hidden relative border-l border-gray-200 dark:border-gray-700">                  
            ...
            <li class="mb-10 ml-6">
                ...
                <h3 class="mb-1 text-lg font-semibold text-white">EVRMC</h3>
                <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
                  August 2017 - December 2020
                </time>
                <p class="text-base font-normal text-gray-500 dark:text-gray-400">
            ...
            <li class="ml-6">
                ...
                <h3 class="mb-1 text-lg font-semibold text-white">Scibiz Informatics</h3>
                <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
